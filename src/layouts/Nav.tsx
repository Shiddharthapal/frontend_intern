  ...
  return (
    <div className="w-full bg-[#f8f8f8] flex items-center justify-between px-6 py-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100">
          <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" strokeWidth="1.8" strokeLinecap="round"/>
            <path d="M13.73 21a2 2 0 0 1-3.46 0" strokeWidth="1.8" strokeLinecap="round"/>
          </svg>
        </button>
        ...
        <div className="flex items-center gap-3 ml-1">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-gray-800 leading-tight">Totok Michael</span>
            <span className="text-xs text-gray-400">tmichael20@mail.com</span>
          </div>
        </div>
      </div>
    </div>
